...
void saldo()
{
    ...
    case 1:
        ...
        while (fread(&useraktif, sizeof(useraktif), 1, akun) == 1)
        {
            if (strcmp(useraktif.username, useraktif.username) == 0)
            {
...
void marketplace()
{
    ...
    total_harga = seller_data.harga * pesan.jumlah;
    ...
    case 1:
        ...
        if (total_harga > useraktif.saldo)
        {
    ...
    case 2:
        ...
        scanf("%d", &data.pengeluaran);

        if (data.pengeluaran >= total_harga)
        {
            printf("Pembayaran berhasil & pesanan Anda telah dibuat\n");
            system("pause");
            system("cls");
            menucustomer();
        }
        ...
        {
            printf("Mohon maaf, jumlah pembayaran Anda kurang\n");
            system("pause");
            system("cls");
            menucustomer();
        }
...
void lihat_pesanan()
{
    ...
    while (fread(&pesanan, sizeof(pesanan), 1, file) == 1)
    {
...
{
    printf("-----------------------------\n");
    printf("- Halo Costmer kesayangan   -\n");
    printf("- SElamat datang di Layanan -\n");
    printf("- IndoLance                 -\n");
    printf("-----------------------------\n\n");
    printf("-----------------------------\n");
    printf("- JIka ada yang ingin kamu  -\n");
    printf("- tanyakan? silahkan pilih  -\n");
    printf("- pertanyaan dibawah ini    -\n");
    printf("- dan klik apa saja untuk   -\n");
    printf("- melihat pertanyaan        -\n");
    printf("-----------------------------\n\n");
    system("pause");
    system("cls");
    ...
    int pilih;
    printf("---------------------------------------------------\n");
    printf("- 1. Bagaimana cara memesan jasa IndoLance?       -\n");
    printf("- 2. Apakah boleh memesan lebih dari 1 jasa?      -\n");
    printf("- 3. Kapan pembayaran dilakukan?                  -\n");
    printf("- 4. Apakah pesanan bisa dibatalkan?              -\n");
    printf("- 5. kemana hasil pesanan jasa dikirim?           -\n");
    printf("- 6. Kembali                                      -\n");
    printf("---------------------------------------------------\n");
    printf("\nPilih (1/2/3/4/5) : ");
    scanf("%d", &pilih);
    ...
    case 1:
        printf("--------------------------------------------------\n");
        printf("- 1. masuk ke bagian marketplace                 -\n");
        printf("- 2. pilih jasa yang dibutuhkan                  -\n");
        printf("- 3. masukkan data diri pemesan                  -\n");
        printf("- 4. melakukan pembayaran melalui E-Wallet       -\n");
        printf("--------------------------------------------------\n");
        printf("\n\n");
        system("pause");
        helpdesk();
    ...
    case 2:
        printf("-------------------------------------------------\n");
        printf("- boleh, dengan seller yang berbeda             -\n");
        printf("-------------------------------------------------\n");
        system("pause");
        helpdesk();
        break;
    case 3:
        printf("-------------------------------------------------\n");
        printf("- Pembayaran dilakukan di awal transaksi        -\n");
        printf("-------------------------------------------------\n");
        system("pause");
        helpdesk();
        break;
    case 4:
        printf("------------------------------------------------\n");
        printf("- untuk saat ini pembatalan pesanan belum      -\n");
        printf("- tersedia                                     -\n");
        printf("------------------------------------------------\n");
        system("pause");
        helpdesk();
    ...
    case 5:
        printf("------------------------------------------------\n");
        printf("- hasil pesanan yang telah selesai akan        -\n");
        printf("- dikirim melalui email customer               -\n");
        printf("------------------------------------------------\n");
        system("pause");
        helpdesk();
    case 6:
